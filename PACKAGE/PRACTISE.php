...
?><style>
 div.sticky{
    ...
    <center>
        ...
        <form method="post">
            <p>   <div class="custom-control custom-radio">
                <input type="radio" id="customRadio1" name="laan" value="c" onchange="this.form.submit()" class="custom-control-input">
  <label class="custom-control-label" for="customRadio1">C</label>
</div>
<div class="custom-control custom-radio">
    <input type="radio" id="customRadio2" name="laan" onchange="this.form.submit()" value="java"class="custom-control-input">
  <label class="custom-control-label" for="customRadio2">JAVA</label>
</div></p>
                  </form>
...
$cus="";
  ...
  <div class=\"input-group-prepend\">
    ...
    <label class=\"custom-control-label\" for=\"customControlInline\">Custom-Input</label>
</div>
</div>
</div><div>
...
//SIMPLIFY OUTPUT
      ...
      if($o11!=null)
       ...
       ?>
        ...
        <textarea   class="alert alert-danger"readonly rows="3" cols="170"><?php print_r($o11); ?></textarea>
<?php
}
include'footer.html';
?>
